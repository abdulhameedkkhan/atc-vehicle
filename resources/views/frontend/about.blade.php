...
<section class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-xl text-indigo-100">Learn more about our company and what we do</p>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center">
                <div class="w-32 h-32 bg-gradient-to-br from-indigo-400 to-purple-500 rounded-full mx-auto mb-6 flex items-center justify-center">
                    <span class="text-4xl text-white font-bold">NK</span>
                </div>
                <h3 class="text-xl font-bold text-gray-900 mb-2">Najeebullah Khan</h3>
                <p class="text-indigo-600 font-medium mb-3">President</p>
                <p class="text-gray-600">
                    Visionary leader driving ATC Japan's mission to deliver excellence in automotive parts and services.
                </p>
            </div>
            <div class="text-center">
                <div class="w-32 h-32 bg-gradient-to-br from-purple-400 to-pink-500 rounded-full mx-auto mb-6 flex items-center justify-center">
                    <span class="text-4xl text-white font-bold">AK</span>
                </div>
                <h3 class="text-xl font-bold text-gray-900 mb-2">Ayaz Khan</h3>
                <p class="text-purple-600 font-medium mb-3">Managing Director</p>
                <p class="text-gray-600">
                    Strategic operations expert ensuring seamless service delivery and client satisfaction.
                </p>
            </div>
            <div class="text-center">
                <div class="w-32 h-32 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-full mx-auto mb-6 flex items-center justify-center">
                    <svg class="w-16 h-16 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"/>
                    </svg>
                </div>
                <h3 class="text-xl font-bold text-gray-900 mb-2">Expert Team</h3>
                <p class="text-cyan-600 font-medium mb-3">Professional Staff</p>
                <p class="text-gray-600">
                    Skilled technicians and logistics experts committed to quality and customer service.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="flex items-start">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-indigo-100">Japanese and international brands available</p>
                </div>
            </div>
        </div>
    </div>
