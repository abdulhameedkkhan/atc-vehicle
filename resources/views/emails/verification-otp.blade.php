...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px;">
        ...
        <p style="color: #4b5563;">Thank you for registering with ATC Japan. Please use the following OTP to verify your email address:</p>
        ...
        <p style="color: #4b5563; margin-top: 30px;">If you didn't request this verification, please ignore this email.</p>
