            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input id="otp" name="otp" type="text" maxlength="6" pattern="[0-9]{6}" required 
                           class="appearance-none relative block w-full px-4 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-red-500 focus:border-red-500 text-center text-xl tracking-widest font-bold @error('otp') border-red-500 @enderror" 
